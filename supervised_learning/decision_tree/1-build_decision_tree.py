#!/usr/bin/env python3
"""
Module for building a decision tree with node counting
"""
import numpy as np
...
class Node:
    ...
    def count_nodes_below(self, only_leaves=False):
        """Counts the nodes or leaves below and including this node"""
        if only_leaves:
...
class Leaf(Node):
    ...
    def count_nodes_below(self, only_leaves=False):
        """Returns 1 because a leaf is always a single node/leaf"""
        return 1
